...
function AminoAcidPopover({
  ...
  const [insertionModalOpen, setInsertionModalOpen] = useState(false);
  ...
  return (
    <>
      ...
      <InsertionModal
        open={insertionModalOpen}
        setOpen={setInsertionModalOpen}
        position={position}
        aminoAcid={aminoAcid}
      />
    </>
